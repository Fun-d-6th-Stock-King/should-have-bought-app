...
import 'package:should_have_bought_app/models/graph/syncfusion/sample_view.dart';
...
class SyncfunsionZoomExample extends StatefulWidget {
  @override
  _RangeSelectorZoomingPageState createState() =>
      _RangeSelectorZoomingPageState();
}

class _RangeSelectorZoomingPageState extends State<SyncfunsionZoomExample>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(height: 400, child: page),
    );
  }
