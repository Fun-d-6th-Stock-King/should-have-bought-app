  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
        ...
        child: Column(children: <Widget>[
          ...
          Container(
              height: 660,
              child: TabBarView(children: <Widget>[BuyRanking(), NotRanking()]))
        ]));
  }
}
    ...
    return Padding(
      ...
      child: Consumer<BuyOrNotProvider>(
        ...
        return Column(
          children: [
            NumberOneRankWidget(
                topRankList.isEmpty == true ? TopRankItem() : topRankList[0],
                evaluation),
            SizedBox(height: 16),
            OtherRankWidget(1,
                topRankList.isEmpty == true ? TopRankItem() : topRankList[1]),
            SizedBox(height: 16),
            OtherRankWidget(2,
                topRankList.isEmpty == true ? TopRankItem() : topRankList[2]),
          ],
        );
      }),
    );
    ...
    return Padding(
      ...
      child: Consumer<BuyOrNotProvider>(
        ...
        return Column(children: [
          ...
          SizedBox(height: 16),
          OtherRankWidget(
              1, topRankList.isEmpty == true ? TopRankItem() : topRankList[1]),
          SizedBox(height: 16),
          OtherRankWidget(
              2, topRankList.isEmpty == true ? TopRankItem() : topRankList[2]),
        ]);
      }),
    );
  }
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => StockDetailScreen(
            Company(company: topRankItem.company,code: topRankItem.code),0)
        ));
      },
      child: Container(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 20),
                      Text(topRankItem?.company ?? '',
                          style: thisBuyOrNotWidgetTitleStyle),
                    ],
                  ),
                  SizedBox(height: 3),
                  Row(
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                              numberWithComma(
                                  topRankItem?.currentPrice.toString() ?? ''),
                              style: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  fontSize: 14,
                                  height: 16 / 14,
                                  color: colorIncreaseOrDecrease(
                                      topRankItem?.changeInPercent ?? 0))),
                          Text(
                              "원 (${checkIncreaseOrDecrease(topRankItem?.changeInPercent)}${topRankItem?.changeInPercent}%)",
                              style: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  fontSize: 14,
                                  height: 16 / 14,
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image(
                          image: AssetImage('assets/icons/ico_like_small.png'),
                        ),
                        SizedBox(width: 1),
                        Text(
                          '살?',
                        ...
                        SizedBox(width: 5),
                        Text(
                            "${numberWithComma(topRankItem?.buyCnt.toString() ?? '')}",
                            style: valueNumberStyle),
                        SizedBox(width: 23),
                        Container(
                            height: 20,
                        ...
                        SizedBox(width: 23),
                        Image(
                          image: AssetImage('assets/icons/ico_unlike_small.png'),
                        ),
                        SizedBox(width: 1),
                        Text('말?',
                            style: TextStyle(
                        ...
                        SizedBox(width: 5),
                        Text(
                            "${numberWithComma(topRankItem?.sellCnt.toString() ?? '')}",
                            style: valueNumberStyle),
                      ],
                    ),
                  )
                  ...
                  child: Row(
                    ...
                    children: [
                      BuyOrNotButtonWidget(
                        type: "BUY",
                        value: topRankItem?.buyCnt ?? 0,
                        //buyOrNotStock?.buyCount ?? 0,
                        onTap: () {
                              ...
                              children: [
                                Text(evaluation?.displayName ?? '',
                                    style: TextStyle(
                                        ...
                                        height: 20 / 14)),
                                SizedBox(width: 10),
                                Text(evaluation?.createdDateText ?? '',
...
const rankingNumberStyle =
    TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: mainColor);

const dateNumberStyle = TextStyle(
    fontWeight: FontWeight.w400, fontSize: 12, color: Color(0xFF8C8C8C));
